...
public class RemoteExpController {
    ...
    public String getTeachLoadList(HttpServletRequest request) throws Exception {
        ...
        List<RemoteExpWorkload> list = expService.findAllLoad(page, limit);
    ...
    @RequestMapping(value = "/saveRemoteExp",
    ...
    @RequestMapping(value = "/removeRemoteExp",
            method = RequestMethod.POST,
            produces = MediaType.APPLICATION_JSON_VALUE + ";charset=utf-8")
    @ResponseBody
